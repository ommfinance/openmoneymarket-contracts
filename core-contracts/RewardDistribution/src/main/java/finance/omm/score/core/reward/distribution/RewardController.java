...
public class RewardController extends RewardDistributionImpl {
    ...
    public void claimRewards(Address _user) {
        ...
        Context.call(this.addressProvider.getAddress(Contracts.OMM_TOKEN.name()), "transfer", _user, unclaimedRewards);
    ...
    public void distribute() {
        ...
        Address workerTokenAddress = this.addressProvider.getAddress(Contracts.WORKER_TOKEN.name());
        Address ommTokenAddress = this.addressProvider.getAddress(Contracts.OMM_TOKEN.name());
        ...
        Address daoFundAddress = this.addressProvider.getAddress(Contracts.DAO_FUND.name());
    ...
    private void checkStakeLp() {
        if (!Context.getCaller()
                .equals(this.addressProvider.getAddress(Contracts.STAKED_LP.name()))) {
    ...
    private void checkLendingPool() {
        if (!Context.getCaller()
                .equals(this.addressProvider.getAddress(Contracts.LENDING_POOL.name()))) {
