...
public class AddressManagerImpl  implements AddressManager {
    ...
    @External // test again through python sdk
...
//        }
    ...
    public void setLendingPoolAddresses() {
        ...
        AddressDetails[] lendingPoolAddressDetails = new AddressDetails[]{
                new AddressDetails(Contracts.LIQUIDATION_MANAGER.getKey(), addresses.get(Contracts.LIQUIDATION_MANAGER.getKey())),
                ...
                new AddressDetails(Contracts.LENDING_POOL_DATA_PROVIDER.getKey(), addresses.get(Contracts.LENDING_POOL_DATA_PROVIDER.getKey())),
                new AddressDetails(Contracts.LENDING_POOL_CORE.getKey(), addresses.get(Contracts.LENDING_POOL_CORE.getKey())),
    ...
    private void addReserve(ReserveAddressDetails reserveAddressDetails, Boolean overwrite){
        ...
        if (_is_reserve_exists && !overwrite){
            throw AddressManagerException.unknown("reserve name " + reserveAddressDetails.reserveName + " already exits.");
        }
